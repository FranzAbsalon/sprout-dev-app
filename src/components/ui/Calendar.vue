...
<template>
  <div class="flex flex-col">
    <DatePickerRoot id="date-field">
      <DatePickerField
        v-slot="{ segments }"
        class="flex select-none bg-white items-center justify-between rounded-lg text-center text-green10 border p-1 w-full data-[invalid]:border-red-500"
      >
        ...
        <DatePickerTrigger class="focus:shadow-[0_0_0_2px] rounded-md text-xl p-1 focus:shadow-black">
            <font-awesome-icon icon="calendar-days" class="text-primaryColor"/>
        </DatePickerTrigger>
      </DatePickerField>
